...
impl Car {
    ...
    pub fn SetColour(&mut self, mut val: i32) {
        if (val > 4) || (val < 1) {
    ...
    pub fn SetMake(&mut self, mut val: i32) {
        if (val > 4) || (val < 1) {
    ...
    pub fn SetModel(&mut self, mut val: i32) {
        if (val > 4) || (val < 1) {
    ...
    pub fn SetSpeed(&mut self, mut val: i32) {
        if val > 200 {
    ...
    pub fn SetDirection(&mut self, mut val: i32) {
        self.m_Direction = val;
    }
    pub fn ChangeDirection(&mut self, mut val: i32) {
