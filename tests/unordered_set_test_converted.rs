...
use String::string;
fn main() {
    let mut mySet = unordered_set::new().clone();
    if mySet.empty() {
        print!("Unordered_set is empty\n");
    } else {
        print!("Unordered_set is not empty\n");
    }
    mySet.insert(5);
    mySet.insert(10);
    mySet.insert(15);
    mySet.insert(20);
    print!("Size of unordered_set: {}\n", mySet.size());
    print!("Count of 10 in unordered_set: {}\n", mySet.count(10));
    print!("Count of 25 in unordered_set: {}\n", mySet.count(25));
    mySet.erase(15);
    print!("Size of unordered_set after erasing: {}\n", mySet.size());
    let mut anotherSet = unordered_set::new().clone();
